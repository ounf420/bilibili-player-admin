...
<body>
    <div class="min-h-screen">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-16">
                    <div class="flex items-center gap-4">
                        ...
                        <h1 class="text-xl font-bold text-gray-900">创建播放器</h1>
            </div>
        </nav>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <form action="{{ route('user.player.store') }}" method="POST">
                @csrf
                ...
                <div class="form-card mb-6">
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-input" value="{{ old('name') }}" required placeholder="例如：我的视频播放器">
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <div class="color-picker">
                                ...
                                <div class="color-option" style="background: #1e293b" data-color="#1e293b"></div>
                            </div>
                            <input type="hidden" name="theme_color" id="theme_color" value="#6366f1">
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="form-group">
                                <label class="form-label">Logo URL</label>
                                <input type="text" name="logo_url" class="form-input" value="{{ old('logo_url') }}" placeholder="https://example.com/logo.png">
                            </div>
                            <div class="form-group">
                                <label class="form-label">进度条图标</label>
                                <input type="text" name="progress_icon_url" class="form-input" value="{{ old('progress_icon_url') }}" placeholder="跟随进度条移动的小图标URL">
                                <div style="font-size:11px;color:#999;margin-top:4px;">类似爱奇艺角色效果，建议32x32透明PNG，留空不显示</div>
                            </div>
                            <div class="form-group">
                                <label class="form-label">水印文字</label>
                                <input type="text" name="watermark_text" class="form-input" value="{{ old('watermark_text') }}" placeholder="例如：© My Site">
                            </div>
                        </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <div class="checkbox-group">
                                ...
                                <label class="checkbox-item">
                                    <input type="checkbox" name="loop_play" value="1" {{ old('loop_play') ? 'checked' : '' }}>
                                    <span>循环播放</span>
                                </label>
                                <label class="checkbox-item">
                                    <input type="checkbox" name="muted" value="1" {{ old('muted') ? 'checked' : '' }}>
                                    <span>默认静音</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="checkbox-group">
                                ...
                                <label class="checkbox-item">
                                    <input type="checkbox" name="show_controls" value="1" checked>
                                    <span>控制栏</span>
                                </label>
                                <label class="checkbox-item">
                                    <input type="checkbox" name="show_quality" value="1" checked>
                                    <span>画质切换</span>
                                </label>
                                <label class="checkbox-item">
                                    <input type="checkbox" name="show_speed" value="1" checked>
                                    <span>倍速播放</span>
                                </label>
                                <label class="checkbox-item">
                                    <input type="checkbox" name="show_fullscreen" value="1" checked>
                                    <span>全屏按钮</span>
                                </label>
                                <label class="checkbox-item">
                                    <input type="checkbox" name="show_pip" value="1" checked>
                                    <span>画中画</span>
                                </label>
                                <label class="checkbox-item">
                                ...
                                <label class="checkbox-item">
                                    <input type="checkbox" name="show_share" value="1" checked>
                                    <span>分享按钮</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="checkbox-group">
                                <label class="checkbox-item">
                                    <input type="checkbox" name="show_danmaku" value="1">
                                    <span>显示弹幕</span>
                                </label>
                                <label class="checkbox-item">
                                    <input type="checkbox" name="allow_danmaku" value="1">
                                    <span>允许发弹幕</span>
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="width" class="form-input" value="100%" placeholder="100%">
                            </div>
                            <div class="form-group">
                                <label class="form-label">高度</label>
                                <input type="text" name="height" class="form-input" value="auto" placeholder="auto">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="border_radius" class="form-input" value="12px" placeholder="12px">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group" id="ad-config-section" style="display: none;">
                            <label class="checkbox-item">
                                <input type="checkbox" name="show_ads" value="1" checked>
                                <span>显示广告</span>
                            </label>
                        </div>

                        <div class="form-group" id="ad-decoration-section" style="display: none;">
                        ...
                        <div class="form-group" id="ad-module-required">
                            <div class="bg-gray-50 border border-gray-200 rounded-lg p-4 text-center">
                                <div class="text-gray-500 mb-2">
                                    <i class="fas fa-lock text-xl"></i>
                                </div>
                                <p class="text-gray-600 text-sm mb-2">广告投放功能需要先开通广告模块</p>
                                <p class="text-gray-400 text-xs">创建播放器后，可在播放器详情页购买广告模块</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-end gap-4">
                        <a href="{{ route('user.player.index') }}" class="btn-secondary">取消</a>
                        <button type="submit" class="btn-primary">
                            <i class="fas fa-save mr-2"></i>创建播放器
                        </button>
                    </div>
                </div>
            </form>
